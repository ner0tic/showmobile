...
/**
 * ShowmobileAddressBook form base class.
 *
 * @method ShowmobileAddressBook getObject() Returns the current form's model object
 *
 * @package    showmobile
 * @subpackage form
 ...
 */
abstract class BaseShowmobileAddressBookForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('showmobile_address_book[%s]');
