...
/**
 * ShowmobileDriver form base class.
 *
 * @method ShowmobileDriver getObject() Returns the current form's model object
 *
 * @package    showmobile
 * @subpackage form
 ...
 */
abstract class BaseShowmobileDriverForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('showmobile_driver[%s]');
