...
/**
 * ShowmobileAddressBook filter form base class.
 *
 * @package    showmobile
 * @subpackage filter
 ...
 */
abstract class BaseShowmobileAddressBookFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('showmobile_address_book_filters[%s]');
