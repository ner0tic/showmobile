...
/**
 * ShowmobileDriver filter form base class.
 *
 * @package    showmobile
 * @subpackage filter
 ...
 */
abstract class BaseShowmobileDriverFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('showmobile_driver_filters[%s]');
