<table>
  <tbody>
    <tr>
      <th>Id:</th>
      <td><?php echo $showmobile_address_book->getId() ?></td>
    </tr>
    <tr>
      <th>Label:</th>
...
<a href="<?php echo url_for('addressBook/edit?id='.$showmobile_address_book->getId()) ?>">Edit</a>
&nbsp;
<a href="<?php echo url_for('addressBook/index') ?>">List</a>
